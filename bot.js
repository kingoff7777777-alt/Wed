...
en: [“What is this site?”, “Who is 부이뒤칸?”, “How to post?”]
};
...
“.ipr-b{padding:8px 12px;border-radius:14px;font-family:Nunito,sans-serif;font-size:13px;line-height:1.5;word-break:break-word;white-space:pre-wrap;}”,
“.ipr-b.ai{background:#1c1535;border-bottom-left-radius:3px;color:#f0eaff;}”,
“.ipr-b.user{background:linear-gradient(135deg,#a855f7,#ff6eb4);border-bottom-right-radius:3px;color:#fff;}”,
...
“#ipr-send{background:linear-gradient(135deg,#a855f7,#38bdf8);color:#fff;border:none;width:36px;height:36px;border-radius:50%;font-size:15px;cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0;}”,
“#ipr-send:disabled{opacity:.5;cursor:not-allowed;}”,
“#ipr-pw{font-family:Nunito,sans-serif;font-size:9px;color:rgba(240,234,255,.2);text-align:center;padding:4px 0;background:#0f0a1e;flex-shrink:0;}”
].join(””);
...
“<div id="ipr-hd">” +
“<div id="ipr-av">🤖</div>” +
“<div><div id="ipr-name">AI Assistant</div><div id="ipr-st">● Online</div></div>” +
